...
export function Triggers() {
  return (
    <Box display={'flex'} alignItems={'center'} flexDirection={'column'}>
      ...
      <Typography marginTop={'30px'} variant="h1" fontSize="30px">
        Setting up rewards
      </Typography>
      <FormGroup sx={{ alignSelf: 'flex-start', marginTop: '15px' }}>
        <FormControlLabel
          control={<Checkbox defaultChecked />}
          label="Telegram subscription - 50 $TREP"
        />
      ...
      <Box
        sx={{ display: 'flex', marginTop: '15px', justifyContent: 'space-around', width: '100%' }}
      >
